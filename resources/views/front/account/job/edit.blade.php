                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="experience" id="experience" class="form-control">
                                    ...
                                    <option value="2" {{ ($job->experience == 2) ? 'selected' : ''}}>1-2 Year</option>
                                    <option value="3" {{ ($job->experience == 3) ? 'selected' : ''}}>2-3 Year</option>
                                    <option value="4" {{ ($job->experience == 4) ? 'selected' : ''}}>3-4 Year</option>
                                    <option value="5" {{ ($job->experience == 5) ? 'selected' : ''}}>4-5 Year</option>
                                    <option value="6" {{ ($job->experience == 6) ? 'selected' : ''}}>5 Year Plus</option>
