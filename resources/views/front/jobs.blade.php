        ...
        <div class="row pt-5">
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                ...
                <div class="card border-0 shadow p-4">
                    ...
                    <div class="mb-4">
                        <h2>Location</h2>
                        <input type="text" value="{{ Request::get('location') }}" name="loaction" id="loaction" placeholder="Location" class="form-control">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check mb-2"> 
                            ...
                            class="form-check-input " name="job_type[]" type="checkbox" value="{{ $jobType->id }}" id="job-type-{{ $jobType->id }}">    
                ...
                <div class="job_listing_area">                    
                    ...
                    <div class="row">
                      @if($jobs->isNotEmpty())
                            ...
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="bg-light p-3 border">
                                        ...
                                        <p>Experience: {{ $job->experience }} year</p>
                        ...
                        @endforeach
                      @else
                        <div class="col-md-12">No job found</div>
                      @endif                   
                    </div>
                    </div>
                </div>
