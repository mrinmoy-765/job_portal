            ...
            <div class="col-lg-9">
                ...
                <div class="card border-0 shadow mb-4">
                    ...
                    <div class="card-body card-form">
                        <form action="" method="" id="userForm" name="userForm">
                            <div class="card-body  p-4">
                                <h3 class="fs-4 mb-1">Edit {{ $user->name }}'s Profile</h3>
                                <div class="mb-4">
...
<script>
    $("#userForm").submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("admin.editUser",$user->id) }}',
            type: 'put',
            dataType: 'json',
            ...
            success: function(response) {
                ...
                if (response.status == true) {
                    ...
                    $("#email").removeClass('is-invalid')
                        ...
                        window.location.href="{{ route('admin.getUserList') }}";
